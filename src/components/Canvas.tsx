...
export const Canvas = ({
  ...
  return (
    <div
      ...
      style={{
        background: `
          radial-gradient(circle at 15% 45%, rgba(5, 10, 10, 0.8) 0%, transparent 50%),
          ...
          linear-gradient(135deg, #051010 0%, #041212 25%, #051515 50%, #041212 75%, #051010 100%)
        `,
        transition: 'background 0.3s ease',
      }}
    >
      {/* Enhanced grid with vibrant teal colors */}
      <div
